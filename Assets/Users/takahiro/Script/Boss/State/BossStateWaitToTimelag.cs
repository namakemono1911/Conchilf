...
public class BossStateWaitToTimelag : bossState {

    public BossStateWaitToTimelag(boss b) : base(b) { }
    ...
    public override void updateState()
    {
        ...
        if (boss.timer >= boss.BossStatus.shotInterval)
        {
            ...
            // 待機後に時間差攻撃開始
            boss.ChangeState( new BossStateTimelagAtk(boss), bossAnimation.BOSS_ANIMATION_TYPE.ANIMATION_WAIT_0);
        }
    }
